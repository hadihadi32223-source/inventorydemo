...
function App() {
  return (
    <Routes>
      ...
      <Route path="/brands" element={<ProtectedPage path="/brands"><Brands /></ProtectedPage>} />
      <Route path="/manufacturers" element={<ProtectedPage path="/manufacturers"><Manufacturers /></ProtectedPage>} />
      ...
      <Route path="/transfer" element={<ProtectedPage path="/transfer"><Transfer /></ProtectedPage>} />
      ...
      <Route path="/barcode" element={<ProtectedPage path="/barcode"><BarcodeLabels /></ProtectedPage>} />
