...
export const mockData = {
  ...
  warehouses: [
    ...
    { id: 2, code: 'WH-002', name: 'مستودع الفرع', location: 'صيدا', manager: 'محمود', phone: '07-987654', status: 'active' },
    { id: 3, code: 'WH-DMG', name: 'مستودع التالف', location: 'المركز الرئيسي', manager: 'أمين المستودع', phone: '01-333333', status: 'active' },
  ],
  locations: [
  ...
  activityLog: [
    { id: 1, created_at: `${today}T08:30:00`, user_name: 'أحمد المدير', action: 'اعتماد', entity: 'مستند وارد', entity_id: 'IN-2026-0001', details: 'اعتماد مستند وارد وتوليد حركة مخزون' },
    { id: 2, created_at: `${today}T09:15:00`, user_name: 'أمين المستودع', action: 'اعتماد', entity: 'مستند صادر', entity_id: 'OUT-2026-0001', details: 'اعتماد مستند صادر بعد التحقق من الكمية' },
    { id: 3, created_at: `${today}T11:00:00`, user_name: 'مدير المستودع', action: 'اعتماد', entity: 'الجرد', entity_id: 'CNT-2026-0001', details: 'تسوية فرق جرد مع حركة مخزون عكسية' },
  ],
  users: [
  ...
  permissions: [
    ...
    { id: 3, module: 'الوارد', permission: 'اعتماد', admin: true, manager: true, storekeeper: false, data_entry: false, readonly: false },
    { id: 4, module: 'الصادر', permission: 'اعتماد', admin: true, manager: true, storekeeper: false, data_entry: false, readonly: false },
  ...
  settings: [
    ...
    { id: 2, key: 'backup_path', name: 'مسار النسخ الاحتياطي', value: 'C:/ArabicWms/Backups', group: 'النسخ الاحتياطي' },
  ...
  backups: [
    { id: 1, backup_date: `${today}T12:00:00`, backup_path: 'C:/ArabicWms/Backups/wms-backup-20260707.db', created_by: 'مدير النظام', status: 'success', notes: 'نسخة يدوية' },
  ],
  barcodeLabels: [
...
function readStore(): MockStore {
  if (typeof window === 'undefined' || !window.localStorage) return cloneInitialStore();
  try {
    ...
    return { ...cloneInitialStore(), ...parsed } as MockStore;
  } catch {
