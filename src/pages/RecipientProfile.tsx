...
<body>
  ...
  <div class="grid">
    ...
    <div class="box"><div class="label">الشخص المسؤول</div><div class="value">${value(recipient.contact)}</div></div>
      ...
      <div className="supplier-profile-grid">
        <aside className="supplier-info-card">
          ...
          <div className="supplier-info-list">
            <div><span>الشخص المسؤول</span><strong>{value(recipient.contact)}</strong></div>
